...
| Compatibility aliases | `nb-ultra`, `nb-flow`, `nb-workflow` | Recognize as legacy trigger phrases only; do not use as the product name. Do not create alias directories. |
